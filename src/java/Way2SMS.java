 ...
 * @author Senthil
 */
@WebServlet(urlPatterns = {"/Way2SMS"})
public class Way2SMS extends HttpServlet {
    ...
    public String loginWay2SMS(String userName,String password)
    {
        ...
        try {
            ...
            urlLogin=new URL("http://site24.way2sms.com/entry.action?id=8f2b&ec=0001&username=");
            if(proxy==null)
            {
            ...
            loginConnection.setRequestProperty("Referer", "http://site24.way2sms.com/entry.action?id=8f2b&ec=0001&username=");
    ...
    public void sendSMS(String phoneNumber,String message,String action)
    {
            ...
            try {
                ...
                sendURL=new URL("http://site24.way2sms.com/main.action?Token=494F64F4E7DB88E903AE5A4B55588367.w802&section=s");
                if(proxy==null)
                {
    ...
    public void logoutWay2SMS()
    {
        try {
            ...
            URL logoutURL;
            logoutURL = new URL("http://site21.way2sms.com/entry?ec=0080&id=0.06400061295382686");
            if(proxy==null)
            {
    ...
    {  
        final String USERNAME="9444999732";//REQUIRED
        final String PASSWORD="welcome123";//REQUIRED
        final String ACTION="delsms";//REQUIRED : In order to understand ACTION value please read the blog
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Way2SMS</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Way2SMS at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
